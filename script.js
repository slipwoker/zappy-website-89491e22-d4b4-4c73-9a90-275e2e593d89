document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateField(field) {
      ...
      if (type === 'tel') {
        ...
        if (!telPattern.test(value)) {
          showError(field, field.dataset.errorTel || 'Please enter a valid phone number.');
          return false;
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isValid) {
        ...
        if (firstError) {
          ...
          var fieldTop = firstError.getBoundingClientRect().top + window.pageYOffset - navBarHeight - 20;
  ...
  var animatedElements = document.querySelectorAll(
    '.fade-in, .animate-on-scroll, [data-animate], .section, .card, .feature, .hero-content'
  );
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לפי הספר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '89491e22-d4b4-4c73-9a90-275e2e593d89',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '89491e22-d4b4-4c73-9a90-275e2e593d89';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '89491e22-d4b4-4c73-9a90-275e2e593d89';
